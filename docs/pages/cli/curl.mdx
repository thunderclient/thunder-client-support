...
In the above, we've seen how to easily run requests and collections from the CLI. Thunder Client CLI also integrates with **cURL commands**, allowing you to run or create requests from the CLI.

### Standard cURL Command
![img](/images/cli/curl1.webp)

### Run cURL using TC CLI
