...
Integration with Git is supported by VS Code settings below, choose **any one** as required. To view Thunder Client settings, open the VS Code settings UI and search for Thunder Client to view all of the extension's settings.
...
- There is no backend or cloud sync; all data is stored locally on your computer.
